    ...
    <section className="mb-8 rounded-2xl overflow-hidden shadow-lg relative h-48 md:h-64 bg-brand-black group transition-all">
      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-6 md:px-10 text-white">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold mb-2 leading-tight">
            Combo <br/>Pé na Areia
          </h2>
          <button className="mt-4 bg-brand-yellow text-brand-black px-6 py-2 rounded-full text-sm font-bold w-fit shadow-lg hover:bg-white transition-colors">
            Ver Oferta
          </button>
      </div>
    </section>
